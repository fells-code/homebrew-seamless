class SeamlessGlance < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/fells-code/seamless-glance-distro/releases/download/v0.1.0-beta.11/seamless-glance-0.1.0-beta.11-aarch64-apple-darwin"
    sha256 "1b5d914bf0bb9ee07a1e542a585aa31305c108b6c5232341dee5c9e1a68bbc95"
  elsif OS.mac?
    url "https://github.com/fells-code/seamless-glance-distro/releases/download/v0.1.0-beta.11/seamless-glance-0.1.0-beta.11-x86_64-apple-darwin"
